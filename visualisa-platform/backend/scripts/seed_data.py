#!/usr/bin/env python3
"""
Seed the Visualisa database with initial reference data.

Usage:
    cd visualisa-platform/backend
...
async def seed_plans(session: AsyncSession) -> list[Plan]:
    plans_data = [
        ...
        },
        {
            ...
            "max_visualisations_per_month": -1,  # -1 == unlimited
...
async def seed_admin_user(session: AsyncSession) -> None:
    email = os.getenv("SEED_ADMIN_EMAIL", "admin@visualisa.web.do")
