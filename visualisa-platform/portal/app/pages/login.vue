<template>
    <div class="w-full max-w-md p-8 bg-card rounded-xl shadow-lg border border-border">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold">Sign in to Visualisa</h1>
            <p class="text-muted-foreground mt-1">Professional Portal</p>
        </div>
        ...
        <p class="text-center text-sm text-muted-foreground mt-6">
            ...
            <NuxtLink to="/register" class="text-primary hover:underline font-medium">Create one</NuxtLink>
        </p>
    </div>
</template>
